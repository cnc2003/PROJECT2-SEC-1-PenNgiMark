...
<template>
    ...
    <div class="flex h-full w-full">
        ...
        <div class="flex flex-col border-2 border-black h-dvh w-1/4">
            ...
            <div class="border-2 border-white m-3 h-full">
                Total Items    
            </div>
            <div class="border-2 border-white m-3 h-1/5">
                Payment Summary
            </div>
            ...
            <button class="border-2 border-white h-20 m-3 mb-6">Place Order</button>
        </div>
    </div>
</template>