        ...
        <section class="border-2 border-white w-3/4" @click="closeModal">
            ...
            <div class="h-full overflow-y-scroll">
                ...
                >
                    ...
                    <hr
                        class="w-full border-gray-400 border-2 rounded mx-4 mb-5 mt-4"
                    />
                        ...
                        <div @click="ToggleClick(item)">
                            <MenuBaseCard>
                                ...
                                <template #modal v-if="item.selected">
                                    <div
                                        class="flex flex-col items-center justify-center card w-80 h-96"
                                    >
                                        <p
                                            class="text-2xl font-bold text-pink-500 mt-10 mb-5"
                                        >
                                            Sweetness Level
                                        </p>
                                        <div class="text-xl">
                                        ...
                                        <br />
                                        <div
                                            class="flex w-full h-auto justify-around items-end"
                                        >
                                            <button
