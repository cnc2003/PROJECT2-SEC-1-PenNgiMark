...
<template>
    <div class="fixed flex justify-center items-center gap-4 z-10 inset-0 bg-gray-500 bg-opacity-60 w-screen"
        @click="$emit('closeModal', false), $event">
        <div class="bg-white w-auto h-auto flex flex-col gap-2 justify-center rounded-3xl p-10"
            ...
            <div class="mb-3">
                ...
                <div name="drinks " class="w-full flex flex-col">
                    ...
                    <div name="drinks container" class="border border-gray-300 rounded-md p-4">
                        <CartCard v-for="(menu, index) in menus" :key="index"
            ...
            /> -->
                            ...
                            <template #quantity>
                                ...
                                <div class="flex flex-row gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6 hover:scale-[105%]"
                        ...
                        <div name="flex" class="flex justify-center w-full h-10">
                ...
                <div>
                    ...
                    <input type="number" v-model.number="discount" min="0"
                        class="p-0.5 border border-gray-300 rounded-lg outline-none" />
                </div>
            </div>
            <div class="flex flex-col gap-2 justify-center items-center">
                <button @click="savePromotion" class="btn btn-sm bg-green-500 hover:bg-green-600 w-[80%]">
                    Save
                </button>
                <button @click="$emit('closeModal', false)" class="btn btn-sm btn-warning btn-outline w-[80%]">
                    CloseModal
                </button>
            </div>
